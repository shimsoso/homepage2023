...
<script src="https://cdn.tiny.cloud/1/61y46pguil74cuj6omx87kbrn6guu7udqilluvy976kxbcjs/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
...
<c:url var="_BASE_PARAM" value="">
	<c:param name="boardType" value="${boartType}" />
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							&nbsp;&nbsp;&nbsp;
							<label for="noticteAtN">아니오 : </label>
							<input type="radio" id="noticeAtN" value="N" name="noticeAt" <c:if test="${result.noticeAt ne 'N'}">checked="checked"</c:if>/>
						</td>
					</tr>
					<tr>
			...
			<div class="btn-cont ar">
				<c:choose>
					<c:when test="${not empty searchVO.boardId}">
						...
						<a href="${delUrl}" id="btn-del" class="btn">삭제</a>
					</c:when>
					<c:otherwise>
